        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          <ImageBackground source={item.image} style={styles.detailHero} imageStyle={styles.detailHeroRadius}>
            <LinearGradient colors={['rgba(7,10,18,0.12)', colors.panel]} style={styles.detailGradient}>
              ...
              <View style={styles.detailHeroCopy}>{item.match > 0 && <Text style={styles.detailMatch}>{item.match}% PARA TI</Text>}<Text style={styles.detailTitle}>{item.title}</Text><Text style={styles.detailSubtitle}>{item.subtitle}</Text></View>
            </LinearGradient>
          </ImageBackground>
