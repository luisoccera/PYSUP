    ...
    <ScrollView style={styles.screen} contentContainerStyle={styles.screenContent} showsVerticalScrollIndicator={false}>
      <View style={styles.profileHero}>
        ...
        <View style={styles.profileIdentity}>
          ...
          <View style={styles.profileCopy}><Text style={styles.profileName}>{name}</Text><Text style={styles.profileHandle}>@{username} · {countries.find((item) => item.code === country)?.name ?? country}</Text><Text style={styles.profileBio}>{bio || 'Aún no has escrito una biografía.'}</Text></View>
          <View style={styles.profileStats}><Stat value={`${stats.saved || saved.length}`} label="guardadas" /><View style={styles.statDivider} /><Stat value={`${stats.reviews || reviews.length}`} label="reseñas" /><View style={styles.statDivider} /><Stat value={`${stats.friends}`} label="amigos" /></View>
        </View>
      </View>
